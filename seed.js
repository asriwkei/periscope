...
// 12-week window. First Monday = Jun 1, 2026. "Today" sits in week index 3.
window.TL = {
  weeks: 12,
  startISO: "2026-06-01",
  nowWeek: 3,
    ...
    epics: [
      {
        ...
        status: "on-track", start: 0, end: 3, assignees: ["maya", "theo"],
      ...
      },
      {
        ...
        status: "done", start: 0, end: 2, assignees: ["leo"],
      ...
      },
      {
        ...
        status: "at-risk", start: 3, end: 6, assignees: ["theo", "nina"],
    ...
    epics: [
      {
        ...
        status: "at-risk", start: 1, end: 5, assignees: ["dane", "sara"],
      ...
      },
      {
        ...
        status: "on-track", start: 4, end: 8, assignees: ["dane"],
      ...
      },
      {
        ...
        status: "on-track", start: 6, end: 9, assignees: ["priya", "leo"],
    ...
    epics: [
      {
        ...
        status: "on-track", start: 2, end: 6, assignees: ["theo", "dane"],
      ...
      },
      {
        ...
        status: "on-track", start: 5, end: 9, assignees: ["maya", "priya"],
      ...
      },
      {
        ...
        status: "at-risk", start: 8, end: 11, assignees: ["leo", "nina"],
    ...
    epics: [
      {
        ...
        status: "on-track", start: 4, end: 7, assignees: ["priya", "maya"],
      ...
      },
      {
        ...
        status: "done", start: 4, end: 6, assignees: ["theo"],
      ...
      },
      {
        ...
        status: "on-track", start: 7, end: 10, assignees: ["sara", "leo"],
